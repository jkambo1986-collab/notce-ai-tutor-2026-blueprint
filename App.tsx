...
const MainApp: React.FC = () => {
  ...
  const handleNext = async () => {
    if (!currentCase || !selectedLabel || !selectedConfidence) return;
            ...
            <section className="flex-1 h-full overflow-y-auto bg-gray-50 p-4 md:p-8">
              {!isCaseComplete ? (
                ...
                <div className="max-w-xl mx-auto space-y-6">
                  ...
                  <button
                    disabled={!selectedLabel || !selectedConfidence}
                    onClick={handleNext}
                    className="w-full py-5 bg-blue-600 text-white rounded-2xl font-bold text-lg shadow-xl shadow-blue-200 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-95"
                  >
